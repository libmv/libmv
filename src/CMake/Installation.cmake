...
CONFIGURE_FILE(../Doxyfile ${PROJECT_BINARY_DIR} COPYONLY)
...
IF (INSTALL_SOURCE STREQUAL ON)
  ...
  INSTALL(DIRECTORY  ../extras
          ...
          COMPONENT sources
          PATTERN ".svn" EXCLUDE)
  INSTALL(FILES ../Makefile ../Doxyfile ../ChangeLog
          DESTINATION ${LIBMV_SHARE_OUTPUT_DIR}
          COMPONENT sources
          PERMISSIONS OWNER_READ GROUP_READ WORLD_READ)
...
IF (BUILD_DOC STREQUAL ON AND INSTALL_DOCUMENTATION STREQUAL ON)
  INSTALL(DIRECTORY  ../doc
          DESTINATION ${LIBMV_SHARE_OUTPUT_DIR}
          COMPONENT documentation
          PATTERN ".svn" EXCLUDE)
ENDIF (BUILD_DOC STREQUAL ON AND INSTALL_DOCUMENTATION STREQUAL ON)
